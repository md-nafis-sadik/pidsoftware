    ...
    return(
        ...
        <div className="mx-[5%] my-4 p-2">
            ...
            <div className="w-full lg:w-2/3">
                ...
                <div className="mb-4">
                    <div className="mb-1">
                        <label htmlFor="lids" className="w-full inline-block mb-2 text-sm font-semibold">Enter Office 365 account(s) separated by line breaks(maximum 50 accounts):</label>
