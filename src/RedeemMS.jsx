...
export default function RedeemMS(){
            ...
            <div className="w-full lg:w-2/3">
                ...
                <div className="mb-4">
                    ...
                    <div className="block sm:flex justify-between items-center text-sm">
                        ...
                        <button className="inline-block px-4 py-2 bg-[#0067b8] rounded-sm text-white font-semibold mb-1 sm:mb-0 text-sm  hover:bg-[#005ba0]">Redeem Data Online</button>
